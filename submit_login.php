...
$ip = json_decode($bop->ipInfo($_SERVER['HTTP_CF_CONNECTING_IP']));
$id = $user->id;
if (isset($ip->code)) {
...
$insert = $bop->query("INSERT INTO login VALUES (NULL, ? , ?, ?, now(), ?, ?)", [$id, $agent, $_SERVER['HTTP_CF_CONNECTING_IP'], "0", "UNK" ]);
}
$_SESSION['id'] = $user->id;
