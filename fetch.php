...
{
if($bop->user_exists($member['uid'])) { // checking before get_user because the query fails when it doesnt find the user
  ...
  <div class="col-2-12 centered" style="padding-right:0px;">
    <a style="color:black;" href="/profile/<?=$user->id?>">
      <img src="https://storage.vertineer.com/avatars/<?=$avatar->cache?>.png" style="width:100%;">
