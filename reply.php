...
if (isset($_POST["token"])) {
	if ($bop->checkToken($_POST["token"])) {
		...
		if($thread->deleted == "1" || $thread->locked == "1")
		{
			die("Bad request");
		}
		...
		$bop->notify($thread->author, $user->username." replied to your thread.", "https://www.vertineer.com/storage/avatars/".$otherAvatar->cache.".png", "/forum/thread.php?id=".$thread->id."/1");
		die("yes");
	}
}
die("3");
