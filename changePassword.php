...
$message = "<center>";
$message .= "<img src='https://www.vertineer.com/images/logo.png'><br>";
$message .= "<h1>Reset your password for {$localUser->username}</h1><br>";
$message .= "<a class='button success' href='https://www.vertineer.com/reset/{$uuid}'>Click here to reset</a>";
$message .= "</center>";
