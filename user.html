...
$admins = $bop->get_user($user->id, ["admin"]);
$respect = $bop->get_user($user->id, ["respected"]);
$remember = $bop->get_user($user->id, ["remembering"]);
?>

<?php
$owner = $bop->get_user($user->id, ["premium"]);
...
<div class="content">
	...
	<div class="col-1-1">
		...
		<img src="https://storage.vertineer.com/heads/<?=$avatar->headshot?>.png" height="60" style="border-radius:100px;float:left;margin-right:5px;" onerror="this.src='https://storage.vertineer.com/header.png'"> <span style="float:left;" title="Status"><?=htmlentities($user->status)?></span>
	...
	<div class="col-4-12">
		<div class="card b centered">
			...
			<div class="body">
			<img src="https://storage.vertineer.com/avatars/<?=$user->avatar?>.png" class="image" onerror="this.src='https://storage.vertineer.com/avatar.png'">
				...
				if($bop->logged_in())
				{
					...
					{
						?>
						<a href="/admin/hideUsername.php?id=<?=$uid?>" class="button danger">Censor</a> &nbsp;<a href="/admin/reRender.php?id=<?=$uid?>" class="button danger">Re-Render</a>
						<?php
					}
				}
				?>
		...
		<div class="card b centered">
			...
			<div class="body" id="wearing">
				<fieldset>
					...
					<div class="col-1-3"><a href="#"><img src="https://storage.vertineer.com/error.png" id="hat1" class="width-100" /></a></div>
					<div class="col-1-3"><a href="#"><img src="https://storage.vertineer.com/error.png" id="hat2" class="width-100" /></a></div>
					<div class="col-1-3" style="padding-right:20px;"><a href="#"><img src="https://storage.vertineer.com/error.png" id="hat3" class="width-100" /></a></div>
				</fieldset>
				<div class="width-333 left centered">
					<fieldset>
						...
						<div style=""><a href="#"><img src="https://storage.vertineer.com/error.png" id="face" class="width-100" /></a></div>
					</fieldset>
				</div>
				<div class="width-333 left centered">
					<fieldset>
						...
						<div style=""><a href="#"><img src="https://storage.vertineer.com/error.png" id="tshir" class="width-100" /></a></div>
					</fieldset>
				</div>
				<div  class="width-333 left centered">
						<fieldset>
							...
							<div style=""><a href="#"><img src="https://storage.vertineer.com/error.png" id="shirt" class="width-100" /></a></div>
						</fieldset>
				</div>
				<div class="width-333 left centered">
					<fieldset>
						...
						<div style=""><a href="#"><img src="https://storage.vertineer.com/error.png" id="pants" class="width-100" /></a></div>
					</fieldset>
				</div>
				<div class="width-333 left centered">
					<fieldset>
						...
						<div style=""><a href="#"><img src="https://storage.vertineer.com/error.png" id="tool" class="width-100" /></a></div>
					</fieldset>
				</div>
				</div>
	...
	<div class="col-8-12">
		...
		<div class="card b">
			<div class="top centered">Achievements</div>
			<div class="body">
			
			<div class="col-1-1">
							<div class="col-1-5 centered">
				<?php if($owner->premium >= 1) { ?>			
				<img src="https://storage.vertineer.com/premium.png" height="150" width="150"><br>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="/achievements.php">Premium</a>
				<?php } ?>
				</div>
				<?php if($admins->admin >= 1) { ?>		
				<div class="col-1-5 centered">
				<img src="https://vertineer.com/admin2.png" height="150" width="150"><br>
				<a href="/achievements.php">Administrator</a>
				</div>
				<?php } ?>
				
				<?php if($respect->respected >= 1) { ?>		
				<div class="col-1-5 centered">
				<img src="https://storage.vertineer.com/soa.png" height="150" width="150"><br>
				<a href="/achievements.php">Respect</a>
				</div>
				<?php } ?>
				
				<?php if($remember->remembering >= 1) { ?>		
				<div class="col-1-5 centered">
				<img src="https://vertineer.com/remembering.png" height="150" width="150"><br>
				<a href="/achievements.php">Remembering</a>
				</div>
				<?php } ?>
		...
		<div class="card b">
			...
			<div class="body">
					...
					foreach($friends as $friend)
					{
						...
						<div class="col-1-5 centered" style="padding-right:0;">
							<a style="color:black;" href="/profile/<?=$friend->user_id?>">
								<img src="https://storage.vertineer.com/avatars/<?=$friend->cache?>.png" style="width:100%;">
				...
				<div class="col-1-1 centered">
					<a class="button success" href="/profiles/friends.php?id=<?=$user->id?>&p=1">View All</a>
				</div>
			</div>
		</div>
		<div class="card b">
			...
			<div class="body">
				...
				foreach($communities as $community)
				{
					...
					<div class="col-3-12 centered" style="padding-right:0px">
						<a href="/community/view/<?=$community['id']?>" style="color:black"><img class="image" src="https://storage.vertineer.com/community/<?=$community['cache']?>.png"><?=$community['name']?></a>
					</div>
					<?php
				}
				?>
		...
		.success((data) => {
			$.each( data.data, function (item, value) {
				if (value.hasOwnProperty("id")) {
					$("#" + value.elm + "").attr('src', "https://storage.vertineer.com/thumbnails/" + value.id + ".png");
					$($("#" + value.elm + "").parent()).attr('href', "/item/" + value.id + "");
				} else {
					$("#" + value.elm + "").attr('src', "https://storage.vertineer.com/error.png");
